...
namespace MCStudio.Framework
{
    ...
    public abstract class DataSource
    {
        ...
        public DataSource(string DBStr)
        {
        }
        ...
        {
            object obj = DataSource.GetSingle(strSql, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        {
            if (sql.ToLower().IndexOf("if not exists ") <= 5)
                return true;
            if (sql.ToLower().IndexOf("drop ") > 10)
                return false;
            if (sql.ToLower().IndexOf("delete ") > 10)
                return false;
            else if (sql.ToLower().IndexOf("update ") > 10)
                return false;
